...
void gendot(char l, char r,int line){
	dot<<l<<dotmap[l]<<line<<" [label="<<l<<"]\n";
	dot<<r<<dotmap[r]<<line+1<<" [label="<<r<<"]\n";
	dot<<l<<dotmap[l]<<line<<"->"<<r<<dotmap[r]<<line+1<<"\n";
